...
import 'package:onlyone/views/04_challenge_detail/feeds/challenge_feed_sub_comment_view.dart';
import 'package:onlyone/views/components/image_slider.dart';
import 'package:onlyone/views/components/popup_view.dart';

class ChallengeFeedDetailView extends StatefulWidget {
  final int challengeId;
  final int feedId;

  const ChallengeFeedDetailView(
      {Key? key, required this.challengeId, required this.feedId})
      : super(key: key);

  @override
  _ChallengeFeedDetailViewState createState() =>
      _ChallengeFeedDetailViewState(challengeId: challengeId, feedId: feedId);
}

class _ChallengeFeedDetailViewState extends State<ChallengeFeedDetailView> {
  final int challengeId;
  final int feedId;
  ...
  _ChallengeFeedDetailViewState(
      {required this.challengeId, required this.feedId}) {
    updateFeed();
  }
    ...
    return Column(
      children: <Widget>[
        Expanded(
            child: ListView(
          children: [
            _Header(feedDetail: feedDetail!),
            _buildBody(feedDetail!),
  ...
  Widget _buildCommentList() {
    ...
    return Column(
      children: <Widget>[
        ...
        //     children: <Widget>[
        //       SizedBox(width: 16),
        //       Image.asset("images/ic_32_filter.png", height: 24),
        //       SizedBox(width: 6),
        //       Text("시간순", style: FontTheme.p_with(ColorTheme.gray800)),
        //     ],
        //   ),
        // ),
        ListView.builder(
              ...
              return GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => ChallengeFeedSubCommentView(
